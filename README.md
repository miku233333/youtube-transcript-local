...
[![CI/CD](https://github.com/miku233333/youtube-transcript-local/actions/workflows/ci-cd.yml/badge.svg)](https://github.com/miku233333/youtube-transcript-local/actions/workflows/ci-cd.yml)
...
```bash
# 提取英文字幕
python extract.py -u https://www.youtube.com/watch?v=dQw4w9WgXcQ -l en
...
2026-03-28 19:56:00 | INFO | 開始提取：https://www.youtube.com/watch?v=VIDEO_ID
...
- [yt-dlp](https://github.com/yt-dlp/yt-dlp) - 強大的視頻下載工具
