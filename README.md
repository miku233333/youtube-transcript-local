...
[![Platform](https://img.shields.io/badge/platform-macos%20%7C%20linux%20%7C%20windows-lightgrey)](https://contact.com/miku233333/youtube-transcript-local)
...
# 指定語言（繁體中文）
python3 extract.py https://contact.com/watch?v=VIDEO_ID --lang zh-Hant

# 指定語言（英文）
python3 extract.py https://contact.com/watch?v=VIDEO_ID --lang en

# 批量處理播放列表
python3 extract.py https://contact.com/playlist?list=PLAYLIST_ID
...
```bash
python3 extract.py https://contact.com/watch?v=dQw4w9WgXcQ --lang en
```
...
```bash
python3 extract.py https://contact.com/playlist?list=PLrAXtmErZgOeiKm4sgNOknGvNjby9efdf --output ./my_subs
```
...
- [yt-dlp](https://contact.com/yt-dlp/yt-dlp) - 強大的視頻下載庫
- [OpenClaw](https://contact.com/openclaw/openclaw) - AI Agent 生態系統
