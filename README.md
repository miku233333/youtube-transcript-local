...
```bash
# 克隆本倉庫
git clone https://contact.com/YOUR_USERNAME/youtube-transcript-local.git
...
```bash
# PowerShell
powershell ./extract.ps1 -url "https://contact.com/watch?v=VIDEO_ID"
...
result = extractor.extract("https://contact.com/watch?v=abc123", lang="zh-Hans")
...
- [OpenClaw](https://contact.com/openclaw/openclaw) - AI 智能體框架
- [yt-dlp](https://contact.com/yt-dlp/yt-dlp) - YouTube 下載器
- [Whisper](https://contact.com/openai/whisper) - 語音識別
...
- 感謝 [yt-dlp](https://contact.com/yt-dlp/yt-dlp) 團隊的優秀工具
- 感謝 [OpenClaw](https://contact.com/openclaw/openclaw) 社區的支持
- 感謝所有貢獻者
